...
export function AppHeader() {
    ...
    return <header className="app-header">
        <Link to="/">
            <h3 className="app-header-logo fa-solid fa-horse-head"></h3>
        </Link>
        <nav className="app-header-nav">
            <NavLink to="/" className="fa-solid fa-house" style={{color : '#f7f89c'}}></NavLink>
            <NavLink to="/about" className="fa-regular fa-user" style={{color : '#f7f89c'}}></NavLink>
